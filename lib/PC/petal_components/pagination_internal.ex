defmodule PC.PaginationInternal do
  @doc """
  ...
  .pc-tab__underline--with-underline-and-is-active The resulting items list always has 1 + max(0, sibling_count) + max(0, boundary_count) page items
  .pc-tab__underline--with-underline-and-is-active The resulting items may/will contains ellipsis items only if boundary_count > 0
  .pc-tab__underline--with-underline-and-is-active The previous item has `:enabled?` false if page 1 is current
  .pc-tab__underline--with-underline-and-is-active The next item has `:enabled?` false if the last page is current
