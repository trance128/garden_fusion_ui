defmodule PC.HeroiconsV1.Outline do
  @moduledoc """
  Icon name can be the function or passed in as a type eg.

      <PC.HeroiconsV1.Solid.home class="w-5 h-5" />
      <PC.HeroiconsV1.Solid.home title="Optional title for accessibility" class="w-5 h-5" />
      <PC.HeroiconsV1.Solid.render icon="home" class="w-5 h-5" />

      <PC.HeroiconsV1.Outline.home class="w-6 h-6" />
      <PC.HeroiconsV1.Outline.home title="Optional title for accessibility" class="w-6 h-6" />
      <PC.HeroiconsV1.Outline.render icon="home" class="w-6 h-6" />
  """
