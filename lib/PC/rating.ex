defmodule PC.Rating do
  ...
  def rating(assigns) do
    ...
    <div class={["flex items-center gap-1", @class]}>
      ...
      <%= if @include_label do %>
        <span class={["ml-1 text-base font-bold text-gray-700 dark:text-gray-300", @label_class]}>
  ...
  def rating_star(%{type: :empty} = assigns) do
    ...
    <svg
      ...
      viewBox="0 0 24 24"
      class={["w-5 h-5 fill-gray-400 dark:fill-gray-500", @class]}
    >
  ...
  def rating_star(%{type: :filled} = assigns) do
    ...
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      class={["w-5 h-5 fill-warning-500", @class]}
    >
